...
enum RegEx: String {
    ...
    case password = "^.{6,32}$" // Password length 6-15
...
enum AlertMessages: String {
    ...
    case inValidPasswordCoinformation = "Password and confirm password not match"
    ...
    case emptyPasswordCoinformation = "Please enter confirm password"
...
class Validation: NSObject {
    ...
    func validate(values: (type: ValidationType, inputValue: String)...) -> Valid {
        for valueToBeChecked in values {
            ...
            case .passwordCoinformation :
                if let tempValue = isValidString((valueToBeChecked.inputValue, .password, .emptyPasswordCoinformation, .inValidPasswordCoinformation)) {
